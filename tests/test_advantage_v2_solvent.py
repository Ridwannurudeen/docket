...
def test_the_registration_is_served_as_uncommitted_until_it_is_in_history(experiment):
    """Weaker than the two self-attested registrations beside it, and stated as such. When
    the specification and the run are committed together this becomes self-attested; until
    then git records nothing about their order and this record claims nothing from it."""
    ...
    assert "becomes a self-attested registration" in provenance["statement"]
